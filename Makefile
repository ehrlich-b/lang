...
generate-version-info:
	...
	echo 'var LANG_COMMIT *u8 = "$(GIT_COMMIT)";' >> out/version_info.lang; \
...
build: generate-os-layer generate-version-info
	...
	@mkdir -p out
ifeq ($(PLATFORM),macos)
	LANGBE=llvm LANGOS=macos $(LANG) std/core.lang out/version_info.lang src/lexer.lang src/parser.lang src/codegen.lang src/codegen_llvm.lang src/ast_emit.lang src/sexpr_reader.lang src/main.lang -o out/lang_$(VERSION).ll
	clang -O2 out/lang_$(VERSION).ll -o out/lang_$(VERSION)
else
	$(LANG) std/core.lang out/version_info.lang src/lexer.lang src/parser.lang src/codegen.lang src/codegen_llvm.lang src/ast_emit.lang src/sexpr_reader.lang src/main.lang -o out/lang_$(VERSION).s
...
bootstrap: generate-os-layer
	...
	LANGBE=llvm LANGOS=linux /tmp/bootstrap_verify/kernel2 std/core.lang out/version_info.lang src/lexer.lang src/parser.lang src/codegen.lang src/codegen_llvm.lang src/ast_emit.lang src/sexpr_reader.lang src/main.lang -o /tmp/bootstrap_verify/compiler_linux.ll
	...
	LANGBE=llvm LANGOS=macos /tmp/bootstrap_verify/kernel2 std/core.lang out/version_info.lang src/lexer.lang src/parser.lang src/codegen.lang src/codegen_llvm.lang src/ast_emit.lang src/sexpr_reader.lang src/main.lang -o /tmp/bootstrap_verify/compiler_macos.ll
...
bootstrap-local: generate-os-layer
	...
	@mkdir -p bootstrap/current/lang_reader
	@echo 'include "std/os/libc.lang"' > std/os.lang
	LANGBE=llvm LANGOS=linux /tmp/bootstrap_verify/kernel2 std/core.lang out/version_info.lang src/lexer.lang src/parser.lang src/codegen.lang src/codegen_llvm.lang src/ast_emit.lang src/sexpr_reader.lang src/main.lang -o bootstrap/current/compiler_linux.ll
	@echo 'include "std/os/libc_macos.lang"' > std/os.lang
	LANGBE=llvm LANGOS=macos /tmp/bootstrap_verify/kernel2 std/core.lang out/version_info.lang src/lexer.lang src/parser.lang src/codegen.lang src/codegen_llvm.lang src/ast_emit.lang src/sexpr_reader.lang src/main.lang -o bootstrap/current/compiler_macos.ll
	cp /tmp/bootstrap_verify/reader_ast1.ast bootstrap/current/lang_reader/source.ast
	@echo "$(GIT_COMMIT)" > bootstrap/current/COMMIT
	@echo 'include "$(BOOTSTRAP_LIBC)"' > std/os.lang
	@rm -rf /tmp/bootstrap_verify
...
llvm-verify:
	...
	@echo "└────────────────────────────────────────────────────────────────┘"
	LANGBE=llvm LANGOS=macos ./lang std/core.lang out/version_info.lang src/lexer.lang src/parser.lang \
	...
	@echo "└────────────────────────────────────────────────────────────────┘"
	LANGBE=llvm LANGOS=macos /tmp/llvm_verify/gen1 std/core.lang out/version_info.lang src/lexer.lang src/parser.lang \
		src/codegen.lang src/codegen_llvm.lang src/ast_emit.lang \
